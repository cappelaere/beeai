...
def auction_watchers(
    ...
    """
    Count and list watchers for an auction property. Calls api-bid/auction-total-watching/.
    Use for: How many people are watching property 100? Watcher count for auction 500.
    """
    ...
    url = f"{API_BASE}/api-bid/auction-total-watching/"
