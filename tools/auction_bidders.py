...
def auction_bidders(
    ...
    """
    List bidders registered for an auction (property). Calls api-bid/auction-bidders/.
    Use for: How many bidders for property 100? List bidders for auction property 500.
    """
    ...
    url = f"{API_BASE}/api-bid/auction-bidders/"
